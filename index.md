...
humandate: "8 - 10 November"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Tim Booth"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper:  ["Jan Verburg", "Jesko Wagner"]    # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
Ed-DaSH is a **Da**ta **S**cience training programme for **H**ealth and Biosciences. The [team](https://edcarp.github.io/Ed-DaSH/ed_dash_team.html) has developed [new lessons](https://edcarp.github.io/Ed-DaSH/curricula_overview.html) using [The Carpentries](https://carpentries.org/) platform. See [workshops](https://edcarp.github.io/Ed-DaSH/workshops.html) for dates and registration details. All Ed-DaSH workshops are delivered remotely.
